...
template <class T>
Queue<T>::Iterator<T> Queue<T>::end() 
{
    if(m_size == 0)
    {
            //Empty Queue
    ...
    return Iterator(Queue<T>::tail, Queue<T>::m_size);
}

template <class T>
Queue<T>::Iterator<T> Queue<T>::begin()
{
        if(m_size == 0)
        {
            //Empty Queue
...
template <class T>
Queue<T>::Iterator<const T> Queue<T>::begin() const
{
        if(m_size == 0)
        {
            //Empty Queue
...
template <class T>
Queue<T>::Iterator<const T> Queue<T>::end() const
{
    if(m_size == 0)
    {
            //Empty Queue
